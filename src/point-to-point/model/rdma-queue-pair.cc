...
void
RdmaQueuePair::SetInitialSize(uint64_t size)
{
    m_init_size = size;
}

uint64_t
RdmaQueuePair::GetInitialSize()
{
    return m_init_size;
}
...
RdmaQueuePair::GetHash(void)
{
    ...
    buf.RdmaQueuePair_t.sip = sip.Get();
    buf.RdmaQueuePair_t.dip = dip.Get();
    buf.RdmaQueuePair_t.sport = sport;
    buf.RdmaQueuePair_t.dport = dport;
...
RdmaRxQueuePair::GetHash(void)
{
    ...
    buf.RdmaRxQueuePair_t.sip = sip;
    buf.RdmaRxQueuePair_t.dip = dip;
    buf.RdmaRxQueuePair_t.sport = sport;
    buf.RdmaRxQueuePair_t.dport = dport;
    return Hash32(buf.c, 12);
}
